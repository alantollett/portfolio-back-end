...
CREATE TABLE `investment` (
  ...
  CONSTRAINT `investment_ibfk_1` FOREIGN KEY (`email`) REFERENCES `user` (`email`)
...
--
-- Table structure for table `worth`
--
...
CREATE TABLE `worth` (
  ...
  CONSTRAINT `worth_ibfk_1` FOREIGN KEY (`email`) REFERENCES `user` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-15 10:46:23
